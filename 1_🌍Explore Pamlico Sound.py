...
st.markdown(
    f"""
    <div style="text-align: center;">
        <p style="font-size:20px;">Welcome to Pamlico Sound -- home to North Carolina's Oyster Sanctuary Network! Here you can explore the results of our dive team's monitoring efforts. This map will help visualize how oyster densities differ from site to site and year to year! Zoom in and you will see where our dive team has sampled along each Sanctuary and how many oysters they found.</p>
    </div>
    """, 
    unsafe_allow_html=True
)
