...
st.markdown(
    f"""
    <div style="text-align: center;">
        <p style="font-size:20px;">The annual dive surveys involve gathering oyster samples on the various materials that have been used at the sanctuaries. From those samples, we 
         gain insight into the population structure of each Sanctuary. The data also provides snapshots for how well the different materials host oysters. 
        Use the filters on the left to see how density estimates and population structures change between Sanctuaries, materials, and year to year.</p>
    </div>
    """, 
    unsafe_allow_html=True
)
...
with col1:
    ...
    with col4:
        ...
        if df_selection1["total"].isnull().all():
            ...
            st.markdown(f'<p style="font-size:20px; font-family: Arial, sans-serif;">Total Density: {total_density1:,} {oysters_per_sq_meter}</p>', unsafe_allow_html=True)
        ...
        if df_selection1["legal"].isnull().all():
            ...
            st.markdown(f'<p style="font-size:20px; font-family: Arial, sans-serif;">Legal Density: {legal_density1:,} {oysters_per_sq_meter}</p>', unsafe_allow_html=True)
        ...
        if df_selection1["sublegal"].isnull().all():
            ...
            st.markdown(f'<p style="font-size:20px; font-family: Arial, sans-serif;">Sublegal Density: {sublegal_density1:,} {oysters_per_sq_meter}</p>', unsafe_allow_html=True)
    ...
    <div style="text-align: left;">
        <p style="font-size:20px;">(Sanctuary maps include materials through 2023)</p>
    </div>
    """, 
    unsafe_allow_html=True
    )
...
with col3:
    ...
    with col6: 
        ...
        if df_selection2["total"].isnull().all():
            ...
            st.markdown(f'<p style="font-size:20px; font-family: Arial, sans-serif;">Total Density: {total_density2:,} {oysters_per_sq_meter}</p>', unsafe_allow_html=True)
        
        if df_selection2["legal"].isnull().all():
            st.markdown('<p style="font-size:20px; font-family: Arial, sans-serif;">Legal Density: Data not available for this site during this year.</p>', unsafe_allow_html=True)
        else:
            legal_density2 = int(df_selection2["legal"].mean())
            st.markdown(f'<p style="font-size:20px; font-family: Arial, sans-serif;">Legal Density: {legal_density2:,} {oysters_per_sq_meter}</p>', unsafe_allow_html=True)
        
        if df_selection2["sublegal"].isnull().all():
            st.markdown('<p style="font-size:20px; font-family: Arial, sans-serif;">Sublegal Density: Data not available for this site during this year.</p>', unsafe_allow_html=True)
        else:
            sublegal_density2 = int(df_selection2["sublegal"].mean())
            st.markdown(f'<p style="font-size:20px; font-family: Arial, sans-serif;">Sublegal Density: {sublegal_density2:,} {oysters_per_sq_meter}</p>', unsafe_allow_html=True)
