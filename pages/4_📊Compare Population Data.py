...
df = pd.read_csv("data/2019-2023_oyster_densities.csv").query('Collection.Method == "Extraction"')
...
with st.expander("Instructions"):
        st.info("""
            **On this page you can compare side-by-side the oyster density estimates and population structures between different sanctuaries, materials, and from year to year.** 
...
st.sidebar.subheader("Use the filters on the left to make comparisons between sanctuaries, years, and materials.")
st.sidebar.header("Selection 1:")

sanctuary1 = st.sidebar.selectbox(
    "Choose an Oyster Sanctuary:",
    sanctuary_names,
