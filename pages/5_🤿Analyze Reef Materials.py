...
#Instruction text
st.info("""
    **Analyze the past five years of oyster monitoring data by using the sidebar to set filters and interact with the graphs below. Hover your cursor over the plots to get more info or draw a box to zoom in on some data.** 
""")
