...
st.markdown(
    f"""
    <div style="text-align: center;">
        <p style="font-size:20px;">North Carolina's Division of Marine Fisheries has been building Oyster Sanctuaries for nearly 30 years! </p>
        <p style="font-size:20px;">For most of that time, sanctuaries were built with marl limestone. However, other materials such as granite, reef balls, various forms of recycled concrete have also been used for sanctuary contstruction. How these materials persist over time will be incredibly useful for the future of the Sanctuary Program as well as other oyster restoration programs. </p>
        <p style="font-size:20px;">Here you can explore the age of various materials and their respective oyster densities. Click on the legend to isolate materials for a better look.  </p>
    </div>
    """, 
    unsafe_allow_html=True
)
