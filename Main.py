...
text.display_text("DMF's dive team conducts annual monitoring to gather data used to quantify the performance & longevity of the oyster sanctuaries. This dashboard allows users to explore the dataset collected from these yearly SCUBA surveys. Take a look below to get started!")
